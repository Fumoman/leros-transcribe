    ...
    def assemble(prog: String, pass2: Boolean): Array[Int] = {
        ...
        for (line <- source.getLines()) {
            ...
            val instr = tokens(0) match {
                ...
                case "loadh4i" => (LDH4I << 8) + toInt(tokens(1))
                case "loadh5i" => (LDH5I << 8) + toInt(tokens(1))
                case "loadh6i" => (LDH6I << 8) + toInt(tokens(1))
                case "loadh7i" => (LDH7I << 8) + toInt(tokens(1))
